...
var mod$$inline_58 = function(a) {
    ...
    function l() {
        for (; f < S; ) {
            ...
            if (32 === a)
                ...
                ++f;
            else if (5760 <= a && Bb.test(String.fromCharCode(a)))
                ++f;
            else
                break
        }
    ...
    function m(a) {
            ...
            a: {
                ...
                for (var b = ""; ; ) {
                    ...
                    if (92 === d) {
                        ...
                        13 !== d && 10 !== d && 8232 !== d && 8233 !== d || c(x, "Unterminated string constant"),
                        b += String.fromCharCode(d),
                        ++f
                }
            }
        ...
        case 124:
        case 38:
            return b = k.charCodeAt(f + 1),
            a = b === a ? t(124 === a ? Va : Wa, 2) : 61 === b ? t(U, 2) : t(124 === a ? Db : Eb, 1),
            a;
        case 94:
            return a = k.charCodeAt(f + 1),
            a = 61 === a ? t(U, 2) : t(Fb, 1),
        ...
        case 45:
            return b = k.charCodeAt(f + 1),
            b === a ? 45 == b && 62 == k.charCodeAt(f + 2) && na.test(k.slice(M, f)) ? (f += 3,
            h(),
            l(),
            a = z()) : a = t(Gb, 2) : a = 61 === b ? t(U, 2) : t(Hb, 1),
            a;
        case 60:
        case 62:
            return b = k.charCodeAt(f + 1),
            d = 1,
            b === a ? (d = 62 === a && 62 === k.charCodeAt(f + 2) ? 3 : 2,
            a = 61 === k.charCodeAt(f + d) ? t(U, d + 1) : t(Ib, d)) : 33 == b && 60 == a && 45 == k.charCodeAt(f + 2) && 45 == k.charCodeAt(f + 3) ? (f += 4,
            h(),
            l(),
            a = z()) : (61 === b && (d = 61 === k.charCodeAt(f + 2) ? 3 : 2),
            a = t(Jb, d)),
            a;
        case 61:
        case 33:
            return b = k.charCodeAt(f + 1),
            a = 61 === b ? t(Kb, 61 === k.charCodeAt(f + 2) ? 3 : 2) : t(61 === a ? Aa : Xa, 1),
            a;
        case 126:
            return t(Xa, 1)
        }
    ...
    function F() {
        ...
        case eb:
            r();
            var d = a === Ha;
            u(J) || qa() ? b.label = null : p !== V ? N() : (b.label = O(),
            W());
            for (var e = 0; e < w.length; ++e) {
                var g = w[e];
                if (null == b.label || g.name === b.label.name) {
                    if (null != g.kind && (d || "loop" === g.kind))
                        break;
                    if (b.label && d)
                        break
                }
        ...
        case kb:
            ...
            q(b, "IfStatement");
        case mb:
            return fa || c(x, "'return' outside of function"),
            r(),
            u(J) || qa() ? b.argument = null : (b.argument = A(),
            W()),
            q(b, "ReturnStatement");
        case Oa:
            r();
            ...
            for (w.push(Ob); p != T; )
                ...
                e.consequent = [],
                r(),
                a ? e.test = A() : (d && c(Da, "Multiple default clauses"),
                d = !0,
                e.test = null ),
                v(aa)) : (e || N(),
                e.consequent.push(F()));
        ...
        case pb:
            ...
            v(I),
            a.param = O(),
            C && sa(a.param.name) && c(a.param.start, "Binding " + a.param.name + " in strict mode"),
            v(E),
            a.guard = null ,
            a.body = ga(),
            ...
            b.handler || b.finalizer || c(b.start, "Missing catch or finally clause"),
            q(b, "TryStatement");
        case La:
            return r(),
            ib(b),
            W(),
            q(b, "VariableDeclaration");
        case Ja:
            return r(),
            b.test = ea(),
            w.push(Ia),
            ...
            q(b, "WhileStatement");
        case tb:
            return C && c(x, "'with' in strict mode"),
            r(),
            b.object = ea(),
            b.body = F(),
            q(b, "WithStatement");
    ...
    function Qa(a) {
        ...
        if (u(ya)) {
            ...
            b = c;
        return p.isAssign ? (c = Q(b),
        c.operator = H,
        c.left = b,
        r(),
        c.right = Qa(a),
        ra(b),
        q(c, "AssignmentExpression")) : b
    }
    function Ra(a, b, c) {
        var d = p.binop;
    ...
    function ha(a, b) {
        ...
        c.computed = !0,
        v(ka),
        ha(q(c, "MemberExpression"), b)) : !b && u(I) ? (c = Q(a),
        c.callee = a,
        c.arguments = Ta(E, !1),
        ha(q(c, "CallExpression"), b)) : a
    }
    function ua() {
        switch (p) {
        case ub:
        ...
        case Z:
            ...
            for (r(); !u(T); ) {
                ...
                n.allowTrailingCommas && u(T))
                    break;
                var e = {
                    key: p === ba || p === da ? ua() : O(!0)
                }, g = !1, h;
                u(aa) ? (e.value = A(!0),
                h = e.kind = "init") : 5 <= n.ecmaVersion && "Identifier" === e.key.type && ("get" === e.key.name || "set" === e.key.name) ? (g = d = !0,
                h = e.kind = e.key.name,
    ...
    function Na(a, b) {
        ...
        if (C || a.body.body.length && Ga(a.body.body[0]))
            for (d = a.id ? -1 : 0; d < a.params.length; ++d)
                if (e = 0 > d ? a.id : a.params[d],
                (bb(e.name) || sa(e.name)) && c(e.start, "Defining '" + e.name + "' in strict mode"),
                0 <= d)
                    for (var g = 0; g < d; ++g)
    ...
    ;
    var f, x, X, oa, ia, p, H, R, G, D, Da, M, Ea, fa, w, C, rb = [], ba = {
        type: "num"
    }, Ba = {
        type: "regexp"
    }, da = {
...
Interpreter.prototype.step = function() {
    ...
    if (!a || "Program" == a.node.type && a.done)
        return !1;
    if (this.paused_)
        return !0;
...
Interpreter.prototype.initGlobalScope = function(a) {
    ...
    for (var d = [[escape, "escape"], [unescape, "unescape"], [decodeURI, "decodeURI"], [decodeURIComponent, "decodeURIComponent"], [encodeURI, "encodeURI"], [encodeURIComponent, "encodeURIComponent"]], h = 0; h < d.length; h++)
        c = function(a) {
            return function(c) {
...
Interpreter.prototype.initFunction = function(a) {
    var b = this, c;
    c = function(a) {
        for (var c = this.parent == b.FUNCTION ? this : b.createObject(b.FUNCTION), d = arguments.length ? arguments[arguments.length - 1].toString() : "", p = [], r = 0; r < arguments.length - 1; r++)
        ...
        if (c)
            if (b.isa(c, b.ARRAY))
                for (a = 0; a < c.length; a++)
                    d.arguments[a] = b.getProperty(c, a);
            else
                b.throwException(b.TYPE_ERROR, "CreateListFromArrayLike called on non-object");
        d.doneArgs_ = !0;
        d.doneExec_ = !1
    }
    ;
...
Interpreter.prototype.initObject = function(a) {
    ...
    c = function(a) {
        var c = b.createObject(b.ARRAY), d = 0, p;
        for (p in a.properties)
            b.setProperty(c, d, b.createPrimitive(p)),
            d++;
        return c
    }
    ;
    this.setProperty(this.OBJECT, "getOwnPropertyNames", this.createNativeFunction(c), Interpreter.NONENUMERABLE_DESCRIPTOR);
    c = function(a) {
        var c = b.createObject(b.ARRAY), d = 0, p;
        for (p in a.properties)
            a.notEnumerable[p] || (b.setProperty(c, d, b.createPrimitive(p)),
            d++);
        return c
    }
    ;
    ...
    c = function(a, c, g) {
        ...
        if (g instanceof Interpreter.Object)
            if (!a.properties[c] && a.preventExtensions)
                b.throwException(b.TYPE_ERROR, "Can't define property " + c + ", object is not extensible");
            else {
    ...
    ;
    this.setProperty(this.OBJECT, "defineProperty", this.createNativeFunction(c), Interpreter.NONENUMERABLE_DESCRIPTOR);
    ...
    c = function(a, c) {
        ...
        v || w ? (b.setProperty(q, "getter", v),
        b.setProperty(q, "setter", w)) : (b.setProperty(q, "writable", b.createPrimitive(r)),
    ...
    c = function(a) {
        return a.parent && a.parent.properties && a.parent.properties.prototype ? a.parent.properties.prototype : b.NULL
    }
    ;
    ...
    ;
    this.setProperty(this.OBJECT, "preventExtensions", this.createNativeFunction(c), Interpreter.NONENUMERABLE_DESCRIPTOR);
    c = function() {
        return b.createPrimitive(this.toString())
    }
    ;
    ...
    c = function(a) {
        if (this == b.NULL || this == b.UNDEFINED)
            b.throwException(b.TYPE_ERROR, "Cannot convert undefined or null to object");
        else
            return a = (a || b.UNDEFINED).toString(),
    ...
    c = function(a) {
        for (; ; )
            if (a.parent && a.parent.properties && a.parent.properties.prototype) {
                if (a = a.parent.properties.prototype,
                a == this)
...
Interpreter.prototype.initArray = function(a) {
    ...
    d = function(a) {
        var c = this.parent == b.ARRAY ? this : b.createObject(b.ARRAY)
          , d = arguments[0];
        if (d && "number" == d.type)
            isNaN(b.arrayIndex(d)) && b.throwException(b.RANGE_ERROR, "Invalid array length"),
            c.length = d.data;
        else {
            for (d = 0; d < arguments.length; d++)
                c.properties[d] = arguments[d];
            c.length = d
        }
        return c
    }
    ...
    d = function(a) {
        for (var c = 0; c < arguments.length; c++)
            this.properties[this.length] = arguments[c],
            this.length++;
    ...
    d = function(a, d, p) {
        ...
        for (h = a + d; h < this.length - d; h++)
            this.properties[h] = this.properties[h + d];
        for (h = this.length - d; h < this.length; h++)
            delete this.properties[h];
        this.length -= d;
...
Interpreter.prototype.initDate = function(a) {
    ...
    c = function(a, c, d, r, v, w, q) {
        if (this.parent == b.DATE)
            var g = this;
        else
            return b.createPrimitive(Date());
        if (arguments.length)
            if (1 != arguments.length || "string" != a.type && !b.isa(a, b.STRING)) {
...
Interpreter.prototype.initMath = function(a) {
    ...
    for (a = 0; a < d.length; a++)
        this.setProperty(c, d[a], this.createPrimitive(Math[d[a]]), Interpreter.READONLY_NONENUMERABLE_DESCRIPTOR);
...
Interpreter.prototype.initError = function(a) {
    ...
    this.ERROR = this.createNativeFunction(function(a) {
        ...
        a && b.setProperty(c, "message", b.createPrimitive(String(a)), Interpreter.NONENUMERABLE_DESCRIPTOR);
        return c
    });
...
Interpreter.prototype.isa = function(a, b) {
    if (!a || !b)
        return !1;
    for (; a.parent != b; ) {
        if (!a.parent || !a.parent.properties.prototype)
            return !1;
...
Interpreter.prototype.createPrimitive = function(a) {
    return void 0 === a ? this.UNDEFINED : null === a ? this.NULL : !0 === a ? this.TRUE : !1 === a ? this.FALSE : 0 === a ? this.NUMBER_ZERO : 1 === a ? this.NUMBER_ONE : "" === a ? this.STRING_EMPTY : a instanceof RegExp ? this.populateRegExp_(this.createObject(this.REGEXP), a) : new Interpreter.Primitive(a,this)
}
;
...
Interpreter.prototype.createObject = function(a) {
    ...
    this.isa(a, this.FUNCTION) && (a.type = "function",
    this.setProperty(a, "prototype", this.createObject(this.OBJECT || null )));
    this.isa(a, this.ARRAY) && (a.length = 0,
    a.toString = function() {
        for (var a = [], c = 0; c < this.length; c++) {
            var d = this.properties[c];
            a[c] = !d || d.isPrimitive && (null === d.data || void 0 === d.data) ? "" : d.toString()
        }
        return a.join(",")
    }
    );
...
Interpreter.prototype.populateRegExp_ = function(a, b) {
    ...
    this.setProperty(a, "multiline", this.createPrimitive(b.multiline), Interpreter.READONLY_NONENUMERABLE_DESCRIPTOR);
    a.toString = function() {
        return String(this.data)
    }
    ;
...
Interpreter.prototype.createFunction = function(a, b) {
    ...
    c.node = a;
    this.setProperty(c, "length", this.createPrimitive(c.node.params.length), Interpreter.READONLY_DESCRIPTOR);
    return c
}
;
Interpreter.prototype.createNativeFunction = function(a) {
    ...
    b.nativeFunc = a;
    this.setProperty(b, "length", this.createPrimitive(a.length), Interpreter.READONLY_DESCRIPTOR);
    return b
}
;
...
Interpreter.prototype.nativeToPseudo = function(a) {
    if ("boolean" == typeof a || "number" == typeof a || "string" == typeof a || null === a || void 0 === a || a instanceof RegExp)
    ...
    if (a instanceof Array) {
        ...
        for (c in b = this.createObject(this.OBJECT),
        a)
            this.setProperty(b, c, this.nativeToPseudo(a[c]));
    return b
}
...
Interpreter.prototype.pseudoToNative = function(a) {
    if (a.isPrimitive || this.isa(a, this.NUMBER) || this.isa(a, this.STRING) || this.isa(a, this.BOOLEAN))
        return a.data;
    var b;
...
Interpreter.prototype.getProperty = function(a, b) {
    ...
    if (a == this.UNDEFINED || a == this.NULL)
        return this.throwException(this.TYPE_ERROR, "Cannot read property '" + b + "' of " + a),
        null ;
    if (this.isa(a, this.STRING)) {
        if ("length" == b)
            return this.createPrimitive(a.data.length);
        var c = this.arrayIndex(b);
        if (!isNaN(c) && c < a.data.length)
            return this.createPrimitive(a.data[c])
    } else if (this.isa(a, this.ARRAY) && "length" == b)
        return this.createPrimitive(a.length);
    for (; ; ) {
        if (a.properties && b in a.properties)
            return (c = a.getter[b]) ? (c.isGetter = !0,
            c) : a.properties[b];
        if (a.parent && a.parent.properties && a.parent.properties.prototype)
            a = a.parent.properties.prototype;
        else
...
Interpreter.prototype.setProperty = function(a, b, c, d) {
    ...
    if ("object" != typeof c)
        throw Error("Failure to wrap a value: " + c);
    ...
    if (!a.isPrimitive) {
        if (this.isa(a, this.STRING)) {
            ...
            if ("length" == b || !isNaN(h) && h < a.data.length)
                return
        }
        if (this.isa(a, this.ARRAY)) {
            var g;
            if ("length" == b) {
                ...
                isNaN(b) && this.throwException(this.RANGE_ERROR, "Invalid array length");
                if (b < a.length)
        ...
        if (!a.properties[b] && a.preventExtensions)
            ...
            (h = d.enumerable || !1) ? delete a.notEnumerable[b] : a.notEnumerable[b] = !0,
            c || g ? (delete a.notWritable[b],
            a.properties[b] = this.UNDEFINED) : (d = d.writable || !1) ? delete a.notWritable[b] : a.notWritable[b] = !0;
        else {
            for (d = a; ; ) {
                if (d.setter && d.setter[b])
                    return d.setter[b];
...
Interpreter.prototype.setNativeFunctionPrototype = function(a, b, c) {
    this.setProperty(a.properties.prototype, b, this.createNativeFunction(c), Interpreter.NONENUMERABLE_DESCRIPTOR)
}
;
Interpreter.prototype.deleteProperty = function(a, b) {
    b = b.toString();
    return a.isPrimitive || a.notWritable[b] || "length" == b && this.isa(a, this.ARRAY) ? !1 : delete a.properties[b]
}
;
Interpreter.prototype.getScope = function() {
    for (var a = 0; a < this.stateStack.length; a++)
        if (this.stateStack[a].scope)
            return this.stateStack[a].scope;
...
Interpreter.prototype.createScope = function(a, b) {
    ...
    c.strict = !1;
    b && b.strict ? c.strict = !0 : (a = a.body && a.body[0]) && a.expression && "Literal" == a.expression.type && "use strict" == a.expression.value && (c.strict = !0);
    return c
}
;
...
Interpreter.prototype.getValueFromScope = function(a) {
    var b = this.getScope();
    for (a = a.toString(); b; ) {
        if (a in b.properties)
            return b.properties[a];
        b = b.parentScope
    }
...
Interpreter.prototype.populateScope_ = function(a, b) {
    if ("VariableDeclaration" == a.type)
        ...
        if ("FunctionExpression" == a.type)
            return
    }
    var d = a.constructor, h;
    for (h in a) {
        var g = a[h];
        if (g && "object" == typeof g)
            if (g instanceof Array)
                ...
                g.constructor == d && this.populateScope_(g, b)
    }
}
;
...
Interpreter.prototype.throwException = function(a, b) {
    ...
    void 0 !== b && (a = this.createObject(a),
    this.setProperty(a, "message", this.createPrimitive(b), Interpreter.NONENUMERABLE_DESCRIPTOR));
...
Interpreter.prototype.executeException = function(a) {
    ...
    } while (b && "Program" != b.node.type);if (this.isa(a, this.ERROR)) {
        var b = {
            EvalError: EvalError,
...
Interpreter.prototype.stepArrayExpression = function() {
    ...
    c < b.elements.length ? (a.n = c + 1,
    b.elements[c] ? this.stateStack.unshift({
        node: b.elements[c]
    }) : a.value = void 0) : (a.array.length = a.n || 0,
    this.stateStack.shift(),
...
Interpreter.prototype.stepAssignmentExpression = function() {
    ...
    if (a.doneLeft)
        if (a.doneRight)
            if (a.doneSetter_)
                ...
                if ("=" == b.operator)
                    ...
                    var d = a.leftValue.toNumber()
                      , h = c.toNumber();
                    if ("+=" == b.operator)
                        "string" == a.leftValue.type || "string" == c.type ? (b = a.leftValue.toString(),
                        c = c.toString()) : (b = d,
                        c = h),
                        b += c;
                    else if ("-=" == b.operator)
                ...
                (c = this.setValue(a.leftSide, b)) ? (a.doneSetter_ = b,
            ...
            if (!a.doneGetter_ && "=" != b.operator && (a.leftValue = this.getValue(a.leftSide),
            a.leftValue.isGetter)) {
    ...
    if (a.doneLeft)
        if (a.doneRight) {
            ...
            if ("==" == b.operator || "!=" == b.operator)
                ...
                a = a.isPrimitive ? a.data : a.toString(),
                c += a;
            else if ("in" == b.operator)
                c = this.hasProperty(a, c);
            else if ("instanceof" == b.operator)
                this.isa(a, this.FUNCTION) || this.throwException(this.TYPE_ERROR, "Expecting a function in instanceof check"),
                c = this.isa(c, a);
            else if (c = c.toNumber(),
            a = a.toNumber(),
            "-" == b.operator)
                c -= a;
            else if ("*" == b.operator)
                ...
                throw SyntaxError("Unknown binary operator: " + b.operator);
...
Interpreter.prototype.stepBlockStatement = function() {
    ...
    "Program" != a.node.type && this.stateStack.shift())
}
;
Interpreter.prototype.stepBreakStatement = function() {
    ...
    for (a = this.stateStack.shift(); a && "CallExpression" != a.node.type && "NewExpression" != a.node.type; ) {
        if (b ? b == a.label : a.isLoop || a.isSwitch)
            return;
...
Interpreter.prototype.stepCallExpression = function() {
    ...
    if (a.doneCallee_) {
        if (!a.func_) {
            if ("function" == a.value.type)
                ...
                if ("function" != a.func_.type) {
                    this.throwException(this.TYPE_ERROR, (a.value && a.value.type) + " is not a function");
                    return
                }
            }
            "NewExpression" == a.node.type ? (a.funcThis_ = this.createObject(a.func_),
            a.isConstructor_ = !0) : a.funcThis_ = a.func_.boundThis_ ? a.func_.boundThis_ : a.value.length ? a.value[0] : this.stateStack[this.stateStack.length - 1].thisExpression;
        ...
        if (a.doneExec_)
            this.stateStack.shift(),
            this.stateStack[0].value = a.isConstructor_ && "object" !== a.value.type ? a.funcThis_ : a.value;
        else if (a.doneExec_ = !0,
        a.func_.node) {
            for (var b = this.createScope(a.func_.node.body, a.func_.parentScope), c = 0; c < a.func_.node.params.length; c++) {
            ...
            (b = a.arguments[0]) ? b.isPrimitive ? (b = new Interpreter(b.toString()),
...
Interpreter.prototype.stepConditionalExpression = function() {
    var a = this.stateStack[0];
    a.done ? (this.stateStack.shift(),
    "ConditionalExpression" == a.node.type && (this.stateStack[0].value = a.value)) : a.test ? (a.done = !0,
    a.value.toBoolean() && a.node.consequent ? this.stateStack.unshift({
...
Interpreter.prototype.stepDoWhileStatement = function() {
    var a = this.stateStack[0];
    a.isLoop = !0;
    "DoWhileStatement" == a.node.type && void 0 === a.test && (a.value = this.TRUE,
    a.test = !0);
    a.test ? (a.test = !1,
    a.value.toBoolean() ? a.node.body && this.stateStack.unshift({
        node: a.node.body
    }) : this.stateStack.shift()) : (a.test = !0,
    this.stateStack.unshift({
        node: a.node.test
    }))
}
...
Interpreter.prototype.stepEval_ = function() {
    var a = this.stateStack[0];
    a.interpreter.step() || (this.stateStack.shift(),
...
Interpreter.prototype.stepForInStatement = function() {
    ...
    if (a.doneVariable_)
        if (a.doneObject_) {
            "undefined" == typeof a.iterator && (a.object = a.value,
            a.iterator = 0);
            var c = null ;
            a: do {
                var d = a.iterator, h;
...
Interpreter.prototype.stepForStatement = function() {
    ...
    var b = a.node
      , c = a.mode || 0;
    0 == c ? (a.mode = 1,
    b.init && this.stateStack.unshift({
        node: b.init
    })) : 1 == c ? (a.mode = 2,
    b.test && this.stateStack.unshift({
        node: b.test
    })) : 2 == c ? (a.mode = 3,
    b.test && a.value && !a.value.toBoolean() ? this.stateStack.shift() : b.body && this.stateStack.unshift({
        node: b.body
    })) : 3 == c && (a.mode = 1,
    b.update && this.stateStack.unshift({
        node: b.update
    }))
}
;
...
Interpreter.prototype.stepLogicalExpression = function() {
    ...
    a.doneLeft_ ? a.doneRight_ ? (this.stateStack.shift(),
    this.stateStack[0].value = a.value) : "&&" == b.operator && !a.value.toBoolean() || "||" == b.operator && a.value.toBoolean() ? (this.stateStack.shift(),
    this.stateStack[0].value = a.value) : (a.doneRight_ = !0,
    this.stateStack.unshift({
        node: b.right
    })) : (a.doneLeft_ = !0,
    this.stateStack.unshift({
...
Interpreter.prototype.stepMemberExpression = function() {
    var a = this.stateStack[0]
      , b = a.node;
    a.doneObject_ ? a.doneProperty_ ? (this.stateStack.shift(),
    a.components ? this.stateStack[0].value = [a.object, a.value] : (b = this.getProperty(a.object, a.value)) ? b.isGetter ? (b.isGetter = !1,
    this.stateStack.unshift({
        node: {
            type: "CallExpression"
        },
        ...
        doneArgs_: !0,
        arguments: []
    })) : this.stateStack[0].value = b : (this.stateStack.unshift({}),
    this.throwException(this.TYPE_ERROR, "Cannot read property '" + a.value + "' of " + a.object.toString()))) : (a.doneProperty_ = !0,
    a.object = a.value,
    this.stateStack.unshift({
        node: b.property,
...
Interpreter.prototype.stepObjectExpression = function() {
    var a = this.stateStack[0]
      ...
      , c = a.valueToggle
      , d = a.n || 0;
    a.object ? c ? a.key = a.value : (a.properties[a.key] || (a.properties[a.key] = {}),
    a.properties[a.key][a.kind] = a.value) : (a.object = this.createObject(this.OBJECT),
    ...
    if (b.properties[d])
        ...
        for (var h in a.properties)
            ...
            this.setProperty(a.object, h, null , b)) : this.setProperty(a.object, h, b.init);
        this.stateStack.shift();
...
Interpreter.prototype.stepReturnStatement = function() {
    ...
    if (b.argument && !a.done)
        ...
        do {
            ...
            a = this.stateStack[0]
        } while ("CallExpression" != a.node.type && "NewExpression" != a.node.type);a.value = b
    }
}
;
...
Interpreter.prototype.stepThrowStatement = function() {
    var a = this.stateStack[0]
      , b = a.node;
    a.argument ? this.throwException(a.value) : (a.argument = !0,
    this.stateStack.unshift({
        node: b.argument
    }))
}
...
Interpreter.prototype.stepTryStatement = function() {
    var a = this.stateStack[0]
      , b = a.node;
    a.doneBlock ? a.throwValue && !a.doneHandler && b.handler ? (a.doneHandler = !0,
    this.stateStack.unshift({
        node: b.handler,
        throwValue: a.throwValue
    }),
    a.throwValue = null ) : !a.doneFinalizer && b.finalizer ? (a.doneFinalizer = !0,
    this.stateStack.unshift({
        node: b.finalizer
    })) : a.throwValue ? this.executeException(a.throwValue) : this.stateStack.shift() : (a.doneBlock = !0,
    this.stateStack.unshift({
        node: b.block
    }))
}
    ...
    if (a.done) {
        ...
        if ("-" == b.operator)
            ...
            if (a.value.length)
                ...
                c = this.getScope(),
                a = a.value;
            b = "delete" == b.operator ? this.deleteProperty(c, a) : this.getProperty(c, a).type
        } else if ("void" == b.operator)
            b = void 0;
        else
            throw SyntaxError("Unknown unary operator: " + b.operator);
        ...
        if ("delete" == b.operator || "typeof" == b.operator)
            c.components = !0;
...
Interpreter.prototype.stepUpdateExpression = function() {
    ...
    if (a.doneLeft) {
        ...
        if (a.doneSetter_)
            ...
            var c = a.leftValue.toNumber(), d;
            if ("++" == b.operator)
                d = this.createPrimitive(c + 1);
            else if ("--" == b.operator)
                d = this.createPrimitive(c - 1);
            else
                throw SyntaxError("Unknown update expression: " + b.operator);
            b = b.prefix ? d : this.createPrimitive(c);
            (c = this.setValue(a.leftSide, d)) ? (a.doneSetter_ = b,
            this.stateStack.unshift({
                node: {
                    type: "CallExpression"
                },
...
Interpreter.prototype.stepWithStatement = function() {
    var a = this.stateStack[0]
      , b = a.node;
    a.doneObject ? a.doneBody ? this.stateStack.shift() : (a.doneBody = !0,
